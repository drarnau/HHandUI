...
2. Create an executable file with gfortran:
  - *Normal*: `gfortran -g -fcheck=all -Wall Globals.f90 Utils.f90 Initialisation.f90 VFiteration.f90 Simulation.f90 Main.f90 -o main.out`
  - Optimised: `gfortran Globals.f90 Utils.f90 Initialisation.f90 VFiteration.f90 Simulation.f90 Main.f90 -O3 -o main.out`
3. Execute: `./main`
