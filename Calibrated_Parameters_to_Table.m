...
% Print to latex table
    ...
    fprintf(fid, '$\\epsilon^{\\gamma}_{\\mathcal{M},m}$  & S.d. search cost  & %5.4f \\tabularnewline \n', p(19));
    fprintf(fid, '$\\epsilon^{\\gamma}_{\\mathcal{M},f}$  & S.d. search cost  & %5.4f \\tabularnewline \n', p(20));
    fprintf(fid, '$\\lambda^{u}_{\\mathcal{M},m}$  & Arrival probability unemployed & %5.4f \\tabularnewline \n', p(21));
    fprintf(fid, '$\\lambda^{u}_{\\mathcal{M},f}$  & Arrival probability unemployed & %5.4f \\tabularnewline \n', p(22));
    fprintf(fid, '$\\lambda^{n}_{\\mathcal{M},m}$  & Arrival probability OLF & %5.4f \\tabularnewline \n', p(23));
    fprintf(fid, '$\\lambda^{n}_{\\mathcal{M},f}$  & Arrival probability OLF & %5.4f \\tabularnewline \n', p(24));
    fprintf(fid, '$\\sigma_{\\mathcal{M},m}$  & Losing probability & %5.4f \\tabularnewline \n', p(25));
    fprintf(fid, '$\\sigma_{\\mathcal{M},m}$  & Losing probability & %5.4f \\tabularnewline \n', p(26));
